            ...
            return (
              ...
              >
                ...
                <div className="flex items-center mb-4 sm:mb-6">
                  ...
                  >
                    <IconComponent className="w-5 h-5 sm:w-6 sm:h-6" style={{ color: colorValue }} />
                  </div>
                  <h3 className="text-lg sm:text-xl font-bold font-orbitron text-white">{category.title}</h3>
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {category.skills.map((skill, idx) => (
                    <span
                      ...
                      style={{
                        ...(skillLevels[skill] && {
                          background: `linear-gradient(90deg, ${colorValue}22, transparent ${skillLevels[skill]}%)`,
                        }),
                      }}
                    >
                      {skill}
